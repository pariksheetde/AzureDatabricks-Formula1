...
# MAGIC %md
# MAGIC #### WRITE `circuits.csv` DATA TO THE UNITY CATALOG

# COMMAND ----------

circuits_final_df.write.mode("overwrite").saveAsTable("analytics.formulaone_dev.circuits")

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM analytics.formulaone_dev.circuits;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT COUNT(*) as cnt FROM analytics.formulaone_dev.circuits;
